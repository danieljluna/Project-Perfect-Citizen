...
void spawnFolderIcon(ppc::Entity& entityToModify, ppc::InputHandler& ih, sf::Image& iconSheet, float x, float y, float size, float animSpeed) {
	...
	mousePressButton* mpbFolder = new mousePressButton(ih, *IconRender->getSprite());
...
void spawnSettingsIcon(ppc::Entity& entityToModify, InputHandler& ih, sf::Image& iconSheet, float x, float y, float size, float animSpeed) {
	...
	/// Input Component ///
	mousePressButton* mpbIcon = new mousePressButton(ih, *IconRender->getSprite());
...
void spawnConsoleIcon(ppc::Entity& entityToModify, InputHandler& ih, sf::Image& iconSheet, float x, float y, float size, float animSpeed) {
