...
/// @details Remember, any class that is a child of RenderComponent must 
/// implement void draw(sf::RenderTarget& target, sf::RenderStates states); ,
/// (and for now, render() ). 
///////////////////////////////////////////////////////////////////////////////////
...
public:
	//another way to render. As of right now this is depreciated. See draw() below. 
	virtual void render(sf::RenderWindow* wnd) = 0;

	//This bad boy is a vector that contains pointers to RenderComponents. Whenever an object
	//is created to be rendered, be sure its added to this vector. 
    static std::vector<RenderComponent*> renderVector;

	////////////////////////////////////////////////////////////////////////////////
	/// @brief draw function inherited from sf::Drawable
	/// @details Every class that inheirits from RenderComponent MUST define 
	/// draw(sf::RenderTarget& target, sf::RenderStates states) as it is a virtual
	/// function.
	...
	/// @details Part of the destructor for renderComponent. Removes the specified
	/// element from RenderComponent::renderVector
